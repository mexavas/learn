...
import '/features/personalization/screens/profile/profile_menu.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SProfileMenu(
                  title: 'Name', value: 'Zahid Hasan Sumon', onPressed: () {}),
              ...
              const SProfileMenu(
                  title: 'User ID', value: '454647', icon: Iconsax.copy),
              const SProfileMenu(
                  title: 'E-mail', value: 'zahidsumon15@gmail.com'),
              SProfileMenu(
                  title: 'Phone Number',
                  value: '+8801864465251',
                  onPressed: () {}),
